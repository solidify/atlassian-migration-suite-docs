...
The migration occurs in two steps, first exporting from Jira, then importing to Azure DevOps.

- During the Export, the machine will need a stable connection and access to the Jira server or Jira cloud.
- During the Import, the machine will need a stable connection and access to the ADO Server or ADO Services.

You do not need access to ADO during the export, and similarly you do not need access to Jira during the import.
