...
Creating a new work item type called "Release" in an Azure DevOps Process model and adding a Text Field called "Custom.Fixversions" involves several steps. Here's a straightforward guide to help you through the process:
...
##### Step-by-Step Instructions, adjusting Azure DevOps Work Item Process Model
  ...
  ##### (Optional) Step-by-Step Instructions, create the FixesVersion field on the Azure DevOps Work Item Process Model
